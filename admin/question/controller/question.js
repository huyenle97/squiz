...
app.controller("questionCtl", function($scope,$http,$timeout) {
    ...
    $scope.getQuestions=function(){
        $http.get("http://localhost/squiz/admin/question/controller/getQuestions.php?method=load_questions").then(function (response) {
    ...
    $scope.saveQuestion =function(){
        var request = $http({
            method: "POST",
            url: "http://localhost/squiz/admin/question/controller/postQuestion.php?method=post_question",
            data: {
    ...
    $scope.getAnswerbyQsID =function(){
            ...
            var request = $http({
                method: "POST",
                url: "http://localhost/squiz/admin/question/controller/getAnswersbyQsID.php?method=load_answers",
                data: {
    ...
    $scope.deleteQuestion= function(){
        var request = $http({
            method: "POST",
            url: "http://localhost/squiz/admin/question/controller/deleteQuestion.php?method=del_question",
            data: {
                questionID: $scope.question.ID_Question
            },
            headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
